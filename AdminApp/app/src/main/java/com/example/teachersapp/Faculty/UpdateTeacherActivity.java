...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText        updateTeacherName, updateTeacherEmail, updateTeacherPost,updateTeachernum;
    private Button          updateTeacherBtn, deleteTeacherBtn;

    private String          name, email, image, post, num;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeachernum  = findViewById(R.id.updateTeachernum);
        ...
        updateTeacherBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                num= updateTeachernum.getText().toString();
    ...
    private void checkValidation() {
        if (name.isEmpty()) {
            ...
            updateTeachernum.setError("Empty");
            updateTeachernum.requestFocus();
