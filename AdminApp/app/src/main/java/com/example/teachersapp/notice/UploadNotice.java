        ...
        dbRef.child(uniqueKey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                if(!title.toString().isEmpty()){
                    FcmNotificationsSender notificationsSender= new FcmNotificationsSender("/topics/Notification",title.toString(),noticeTitle.getText().toString(),getApplicationContext(), UploadNotice.this);
                    notificationsSender.SendNotifications();
                }else{
                    Toast.makeText(UploadNotice.this, "Failed to send Notification", Toast.LENGTH_SHORT).show();
                }
                navigateUpTo(new Intent(UploadNotice.this, NoticeActivity.class));
            }
