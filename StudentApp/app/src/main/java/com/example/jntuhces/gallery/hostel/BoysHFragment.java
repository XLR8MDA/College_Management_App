...
public class BoysHFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_boys_h, container, false);
    ...
    private void gethallImage() {
        reference.child("BoysHostel").addValueEventListener(new ValueEventListener() {
    ...
    private void getclassImage() {
        reference.child("BoysMess").addValueEventListener(new ValueEventListener() {
