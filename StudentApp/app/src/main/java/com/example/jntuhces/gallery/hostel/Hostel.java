...
public class Hostel extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            myFragment= inflater.inflate(R.layout.fragment_hostel, container, false);
        ...
        private void setUpViewPager(ViewPager viewPager) {
            ...
            adapter.addFragment(new BoysHFragment(),"Boys");
            adapter.addFragment(new GirlsHFragment(),"Girls");
